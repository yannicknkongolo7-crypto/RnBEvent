    ...
    window.RNB_UPLOAD_API = window.RNB_UPLOAD_API || 'https://1nt249f9ha.execute-api.us-east-2.amazonaws.com/upload-clients';
(function () {
    'use strict';
    ...
    function resetViaEmail() {
        ...
        fetch('https://1nt249f9ha.execute-api.us-east-2.amazonaws.com/send-reset-code', {
            method: 'POST',
    ...
    var LAMBDA_BASE    = 'https://1nt249f9ha.execute-api.us-east-2.amazonaws.com';
    ...
    function sendQuoteEmail() {
        ...
        fetch('https://1nt249f9ha.execute-api.us-east-2.amazonaws.com/send-quote-email', {
            method:  'POST',
            headers: { 'Content-Type': 'application/json' },
            body:    JSON.stringify({
                name:            p.name      || '',
    ...
    function sendBookingEmail(client) {
        ...
        fetch('https://1nt249f9ha.execute-api.us-east-2.amazonaws.com/send-booking-email', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
            body: JSON.stringify({
                email:      client.email,
